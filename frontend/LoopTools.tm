...
:Evaluate: GetDebugKey::usage = "GetDebugKey[key] returns the LoopTools debug key.
	It determines how much debug information is printed for a loop integral."
...
extern void FORTRAN(flush)(CINTEGER *);
...
#define EndRedirect() \
  { CINTEGER fortranstdout = 6; FORTRAN(flush)(&fortranstdout); } \
  fflush(stdout); \
  dup2(prevstdout, 1); \
  close(prevstdout)
