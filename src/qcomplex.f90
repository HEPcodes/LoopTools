...
!		it implements 32-byte (quadruple precision) complex
!		numbers corresponding to the REAL*16 data type
...
contains
	...
	function qr_eq(a, b)
	  ...
	  real*16, intent(in) :: b
	  logical :: qr_eq
	  qr_eq = a%re .eq. b .and. a%im .eq. 0q0
	end function qr_eq
	...
	function rq_eq(a, b)
	  ...
	  type(complex32), intent(in) :: b
	  logical :: rq_eq
	  rq_eq = b%re .eq. a .and. b%im .eq. 0q0
	end function rq_eq
	...
	function qi_eq(a, b)
	  ...
	  integer, intent(in) :: b
	  logical :: qi_eq
	  qi_eq = a%re .eq. b .and. a%im .eq. 0q0
	end function qi_eq
	...
	function iq_eq(a, b)
	  ...
	  type(complex32), intent(in) :: b
	  logical :: iq_eq
	  iq_eq = b%re .eq. a .and. b%im .eq. 0q0
	end function iq_eq
	...
	function qr_ne(a, b)
	  ...
	  real*16, intent(in) :: b
	  logical :: qr_ne
	  qr_ne = a%re .ne. b .or. a%im .ne. 0q0
	end function qr_ne
	...
	function rq_ne(a, b)
	  ...
	  type(complex32), intent(in) :: b
	  logical :: rq_ne
	  rq_ne = b%re .ne. a .or. b%im .ne. 0q0
	end function rq_ne
	...
	function qi_ne(a, b)
	  ...
	  integer, intent(in) :: b
	  logical :: qi_ne
	  qi_ne = a%re .ne. b .or. a%im .ne. 0q0
	end function qi_ne
	...
	function iq_ne(a, b)
	  ...
	  type(complex32), intent(in) :: b
	  logical :: iq_ne
	  iq_ne = b%re .ne. a .or. b%im .ne. 0q0
	end function iq_ne
